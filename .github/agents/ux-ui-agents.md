...
**Do:** Concise phrases, numbers over words ("3 steps"), action-oriented specific CTAs with hover effects, social proof, operational benefits (time saved, cost reduced).

**Do Not:** No generic CTAs ("Learn more", "Click here"), no double negatives, no user-blaming tone, no Lorem Ipsum — use realistic SaaS copy.

**Good CTA Examples:** "Start free trial", "See demo", "Begin audit", "Deploy in 5 minutes", "Get started — it's free"
